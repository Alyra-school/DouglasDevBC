    ...
    useEffect(() => {
        if(isConfirmed) {
            ...
            toast.success("Retrait effectué avec succès!", {
                description: "Vos ETH ont été transférés vers votre wallet",
    ...
    return (
        <div className="bg-card border border-border rounded-xl p-6 shadow-md">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-foreground">Retirer des ETH</h3>
                    <p className="text-xs text-muted-foreground">Retirez vos fonds disponibles</p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    <Label htmlFor="withdraw" className="text-sm font-medium">Montant à retirer</Label>
                    <Input
                        id="withdraw"
                        type="number"
                        step="0.001"
                ...
                <Button
                    className="w-full h-12 text-base font-semibold bg-red-600 hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700"
